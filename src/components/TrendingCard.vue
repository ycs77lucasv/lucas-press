<template>
  <Card class="flex items-center px-5 py-3">
    <div class="w-10 h-10 flex justify-center items-center bg-violet-100 indigo:bg-indigo-100 dark:bg-gray-600 text-violet-600 indigo:text-indigo-600 dark:text-violet-300 rounded-full">
    ...
    <div class="ml-3 flex-grow">
      ...
      <div class="text-3xl font-semibold text-gray-800 dark:text-gray-50">
        {{ value }}
      </div>
    </div>
